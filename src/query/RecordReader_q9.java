...
public class RecordReader_q9 extends AvroTrevniKeyRecordReader<Record>{
	...
	public RecordReader_q9(List<Schema> schemas) {
...
@Override
	public boolean nextKeyValue() throws IOException, InterruptedException {
		...
		if(!reader.hasNext())
			...
			row++;
			tm = reader.next();
			if(reader.getFileSchema().getName().trim().equals("Part") && (!tm.get("p_name").toString().contains("green"))){
